...
export async function POST(request) {
    try {
        ...
        if (!file) return Response.json({ mensaje: 'Ocurrio un error' }, { status: 403 });
        ...
        await conn.query('insert into files_ia(user_id,text,name) values($1,$2,$3)', [user.user_id, pdfText, file.name]);
