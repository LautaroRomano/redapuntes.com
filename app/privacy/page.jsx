...
const Privacy = () => {
  return (
    <div className="container mx-auto p-4 overflow-y-scroll max-h-[80vh]">
      ...
      <p>
        Recopilamos varios tipos de información para diversos fines para
      ...
      <p>
        Mientras usa nuestro servicio, podemos solicitarle que nos proporcione
        cierta información de identificación personal que puede usarse para
      ...
      <ul className="list-disc list-inside ml-4">
        ...
        <li>
          Para recopilar análisis o información valiosa para que podamos mejorar
          nuestro servicio
        </li>
      </ul>
      ...
      <p>
        ...
        ningún método de transmisión a través de Internet o método de
